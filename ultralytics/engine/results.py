...
class Results(SimpleClass):
    ...
    # ) -> None:
    def __init__(self, orig_img, path, names, boxes=None, masks=None, ripeness=None, probs=None, keypoints=None, obb=None, speed=None) -> None:
        """
        ...
        self.path = path
        self.save_dir = None
        self._keys = "boxes", "masks", "probs", "keypoints", "obb", "ripeness"
