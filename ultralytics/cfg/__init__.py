...
TASKS = 'detect', 'segment', 'classify', 'pose', 'ripe'
TASK2DATA = {'detect': 'coco8.yaml', 'segment': 'coco8-seg.yaml', 'classify': 'imagenet10', 'pose': 'coco8-pose.yaml', 'ripe': 'coco8-ripeness.yaml'}
TASK2MODEL = {
    'detect': 'yolov8n.pt',
